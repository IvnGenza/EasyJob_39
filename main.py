...
class Homepage(QMainWindow):
    ...
    def change_to_deletePopup(self,item):
        ...
        self.deletepopup = DeletePopup(item)
    ...
    def handle_buttons(self): # this function handles the click of the signup button
        ...
        self.listWidget_users.itemClicked.connect(self.change_to_deletePopup) #this is for opening the different job ads on the screen after search
...
##########################################################omer omer omer
    def delete_user(self): #deleting the current user
        users = db.child('Users').get()
        for user in users.each(): #this is loop to find the user we want to delete
